  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 right-20 w-96 h-96 bg-[#c8305a] rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2">
              <span className="w-2 h-2 bg-[#c8305a] rounded-full animate-pulse" />
              <span className="text-white/90 text-sm font-medium">Fintech innovadora · Popayán, Colombia</span>
            </div>
